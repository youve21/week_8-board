...
const MessageContainer = () => {
  ...
  const [previousChats, setPreviousChats] = useState([{content: {value:"Hellohhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhh",message: "Hi"}}])

  const getMesages = async (e) => {
    e.preventDefault(); 
    try {
        const response = await axios.post('http://127.0.0.1:5000/chatbot', {value});
